...
import { ExtendedArea } from '@/app/(myapp)/process-map/types';
          ...
          [
...

            {
              ...
              content: (<>
                    ...
                    >
                      ...
                      >
                        <AreaTreeNodeComponent nodes={pm.manageAreas.areas} expandedNodes={pm.manageAreas.expandedNodes} onToggle={pm.toggleNode}
                          ...
                          onEdit={(node, parentAreaId) => { setOpenArea(true); pm.manageAreas.areaForm.openModal(node as ExtendedArea, parentAreaId) }}
                ...
                <AreaModal options={pm.manageAreas.options}
                  open={pm.manageAreas.areaForm.modalState.isOpen}
                  isEditing={!!pm.manageAreas.areaForm.modalState.editingArea}
                  formData={pm.manageAreas.areaForm.formData}
                  allProcesses={pm.allProcesses?.content}
                  setOpen={(open) => (!pm.manageAreas.areaForm.modalState.isOpen ? pm.manageAreas.areaForm.openModal() : pm.manageAreas.areaForm.closeModal())}
