...
export default function Areamodal({
  ...
  const [selectapplicationBaseOptions, setSelectapplicationBaseOptions] = useState<
    IGRPOptionsProps[]
  >([]);
      ...
      <IGRPModalDialog onOpenChange={setOpen} open={open}>
        <IGRPModalDialogContent size={`lg`} className={cn()}>
          <IGRPModalDialogHeader className={cn('')}>
            <IGRPModalDialogTitle name={`modalDialogTitle1`}>{title}</IGRPModalDialogTitle>
          </IGRPModalDialogHeader>
          <IGRPForm
            schema={form1}
