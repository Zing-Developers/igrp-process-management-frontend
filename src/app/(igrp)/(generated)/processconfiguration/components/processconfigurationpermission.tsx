...
export default function Processconfigurationpermission({
  open,
  setOpen,
  processArtifacts,
  onSave,
  ...
  const [repetitiveListrepetitiveList1, setRepetitiveListrepetitiveList1] =
    useState<any[]>([]);
              ...
              <>
                <div className={cn(" space-y-1 mb-4")}>
                  ...
                  <IGRPInputText
                    ...
                    value={formData?.[item.key]?.candidateGroups ?? item.candidateGroups ?? ""}
                  ></IGRPInputText>
                </div>
              </>
            )}
