...
onAddSubarea={ (parentAreaId) => pc.areaForm.openModal(undefined, parentAreaId) } ></AreasList>
        ...
        },
        {
          ...
          icon: `ArrowRight`,
content: (<>
            <ArtifactProcessesList  processes={ pc.allProcesses }  onArtifactEdit={ (processId) => pc.handleOpenArtifactModal(processId) } ></ArtifactProcessesList>
</>),
        },
]
  }
...
<ProcessNumberModal  open={ pc.processNumberForm.modalState.isOpen } formData={ pc.processNumberForm.formData } processNumberConfigs={ pc.processNumberConfigs }  setOpen={ (open) => open ? pc.handleOpenProcessNumberModal(pc.processNumberForm.modalState.selectedProcessId || '',) : pc.processNumberForm.closeModal() }
onFormChange={ pc.processNumberForm.updateFormData }
onSave={ pc.handleSaveProcessNumber } ></ProcessNumberModal></div>
  );
}
