...
<AreasList  areas={ pc.filteredAreas } expandedAreas={ pc.expansion.expandedAreas }  onEdit={ pc.areaForm.openModal }
...
onToggleExpansion={ (areaId) => pc.expansion.toggleAreaExpansion(areaId, pc.areaOperations.loadSubareas) }
onAddSubarea={ (parentAreaId) => pc.areaForm.openModal(undefined, parentAreaId) } ></AreasList></div>
