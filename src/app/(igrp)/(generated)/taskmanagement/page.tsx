...
/>
<CommonUserTaskModalForm  modalTitle={ `Atribuir Tarefa` } userRequired={ true } open={ assignModalState.isOpen } modalSubTitle={ modalSubtitle }  setOpen={ (open) => open? {} : handleCloseAssignModal() }
