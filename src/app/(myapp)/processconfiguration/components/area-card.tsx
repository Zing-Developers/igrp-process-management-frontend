import { ChevronRight, ChevronDown, Building, FolderPlus, Plus, Edit2, Trash2 } from 'lucide-react';
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3 flex-1">
            {(hasContent || canHaveSubareas) && (
              <button onClick={handleToggleExpansion} className="p-1 hover:bg-muted rounded">
                {isExpanded ? (
