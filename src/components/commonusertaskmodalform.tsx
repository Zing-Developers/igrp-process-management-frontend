...
export default function Commonusertaskmodalform({ open, setOpen, onSave, modalTitle, modalSubTitle, userRequired } : { open: boolean, setOpen: (prompt: boolean) => void, onSave: (data: any) => void, modalTitle: string, modalSubTitle: string, userRequired?: boolean }) {
