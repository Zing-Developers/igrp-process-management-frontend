...
export default function Prioritymodal({ open, setOpen, onSave, modalTitle, modalSubTitle } : { open: boolean, setOpen: (prompt: boolean) => void, onSave: (data: any) => void, modalTitle: string, modalSubTitle: string }) {
...
useEffect(() => {
    ...
    setSelectpriorityOptions(dummyPriorities);
  }, []);
