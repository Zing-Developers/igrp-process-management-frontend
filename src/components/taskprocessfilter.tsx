...
export default function Taskprocessfilter({ onSearch, onApplyFilters, onResetFilters, onFiltersChange } : { onSearch: (searchTerm: string) => void, onApplyFilters: (filters: any) => void, onResetFilters: () => void, onFiltersChange: (filters: any) => void }) {
