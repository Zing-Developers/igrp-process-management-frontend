...
export default function Taskprocessfilter({ onSearch, onApplyFilters, onResetFilters } : { onSearch: (searchTerm: string) => void, onApplyFilters: () => void, onResetFilters: () => void }) {
...
{ showFilter && (<div className={ cn('grid','grid-cols-1 ','md:grid-cols-2 ','lg:grid-cols-4 ',' gap-4 px-4 pt-2',)}    >
	<IGRPCombobox
  name={ `Area` }
  label={ `Área` }
variant={ `single` }
